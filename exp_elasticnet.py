'''
This script trains an ElasticNet model with different configurations and logs the results to MLflow.
...
from concrete.ml.sklearn.linear_model import ElasticNet
import mlflow
...
def exp_elastic_net(X_train, y_train, X_test, y_test):
    ...
    for alpha, l1_ratio, fit_intercept, precompute, max_iter, tol, positive, selection, n_bits in product(
        alpha_values, l1_ratio_values, fit_intercept_values, precompute_values, max_iter_values, tol_values, positive_values, selection_values, n_bits_values
    ):
        try:
            current_params = {
                "alpha": alpha,
            ...
            with mlflow.start_run(nested=True):
                ...
                model = ElasticNet(**current_params)
...
if __name__ == "__main__":
    ...
    for dataset_config in dataset_configs:
        ...
        with mlflow.start_run():
            ...
            exp_elastic_net(X_train, y_train, X_test, y_test)